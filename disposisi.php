        ...
        if(isset($_REQUEST['sub'])){
            ...
            switch ($sub) {
                ...
                case 'edit':
                    ...
                    break;
                case 'send':
                    include "send_disposisi.php";
                    break;
                case 'cek':
                    include "cek_disposisi.php";
                    break;
                case 'del':
                            ...
                            <div class="row jarak-form">
                                ...
                                <div class="col m12" id="colres">
                                    <table class="bordered" id="tbl">
                                        ...
                                        $query2 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_surat_masuk ON tbl_disposisi.id_surat = tbl_surat_masuk.id_surat LEFT JOIN
                                                                        tbl_user ON tbl_user.id_user=tbl_disposisi.tujuan WHERE tbl_disposisi.id_surat='$id_surat'");
                                        ...
                                        if(mysqli_num_rows($query2) > 0){
                                            ...
                                            $no++;
                                             echo ' <td>'.$no.'</td>
                                                    <td>'.strtoupper($row['jabatan']).'<br>'.$row['nama'].'</td>
