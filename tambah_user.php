<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['nip'] == "" || $_REQUEST['admin'] == "" || $_REQUEST['jabatan'] == "" || $_REQUEST['nohp'] == ""){
                                ...
                                if($result > 0){
                                    ...
                                    if(strlen($username) < 5){
                                        ...
                                        if(strlen($password) < 5){
                                            ...
                                            $query = mysqli_query($config, "INSERT INTO tbl_user(username,password,nama,nip,admin,jabatan,nohp) VALUES('$username',MD5('$password'),'$nama','$nip','$admin','$jabatan','$nohp')");
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="?page=sett&sub=usr&act=add">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi dengan no WA aktif untuk mendapatkan notifikasi surat via WA">
                            <i class="material-icons prefix md-prefix">notifications</i>
                            <input id="nohp" type="text" class="validate" name="nohp" required>
                                <?php
                                    if(isset($_SESSION['nipuser'])){
                                        $nipuser = $_SESSION['nipuser'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$nipuser.'</div>';
